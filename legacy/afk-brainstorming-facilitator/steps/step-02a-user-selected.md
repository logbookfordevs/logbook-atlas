...
- ✅ SPEAK in a neutral, facilitative voice
...
This path should feel like a curated creative library. The user should feel agency and discovery, not passive filtering.
...
- Keep the browsing experience lively and inviting so selection still feels like part of the session, not admin work
