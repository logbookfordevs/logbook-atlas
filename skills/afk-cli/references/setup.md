...
| `profiles` | Prepares profile members; package installation may be deferred until activation. | Read reported deferred/missing members and inspect profile definitions; setup does not activate a profile. |
